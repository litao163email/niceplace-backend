...
import com.taoli.niceplace.model.enums.TeamStatusEnum;
...
import com.taoli.niceplace.model.vo.UserVO;
import com.taoli.niceplace.service.TeamService;
import com.taoli.niceplace.model.domain.Team;
import com.taoli.niceplace.mapper.TeamMapper;
import com.taoli.niceplace.service.UserService;
import com.taoli.niceplace.service.UserTeamService;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public List<TeamUserVO> listTeams(TeamQuery teamQuery, boolean isAdmin) {
        ...
        //list就是直接查出list，queryWrapper是在上面用eq和and等条件赋值的
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁(避免重复加入队伍)
        RLock lock = redissonClient.getLock("niceplace:join_team");
        try {
            // 抢到锁并执行
            while (true) {
    ...
    public boolean quitTeam(TeamQuitRequest teamQuitRequest, User loginUser) {
        ...
        if (teamHasJoinNum == 1) {
            ...
            if (team.getUserId() == userId) {
                ...
                QueryWrapper<UserTeam> userTeamQueryWrapper = new QueryWrapper<>();
                userTeamQueryWrapper.eq("teamId", teamId);
                //last会把sql语句拼接在mybatis-plus中的sql语句的最后
